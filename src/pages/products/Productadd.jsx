...
// import Switch from "../../Switch";
 import ProductCategory from "../../categoryContext";
...
export default function PreOrderFaq() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // API POST
      const response = await axios.post( "https://e-commerce-backend-1-0.onrender.com/api/products/store", formData);

      if (response.data.success) {
        alert("Product created successfully!");
        navigate("/preorder/dashboard");
      } else {
  ...
  return (
    <div className="PreOrderFaq-whole ">
      <div className="product-table">
        <p className="customersText mt-6 ml-6">Add New Product </p>
      </div>
