            ...
            <tbody>
              {pages.map((page, idx) => (
                <tr key={page._id} className="border-t hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 flex justify-center gap-3">
                    <button className="p-2 rounded-full bg-blue-100" onClick={() => handleEdit(page._id)}>
                      <Pencil size={18} className="text-blue-500" />
                    </button>
                    <button className="p-2 rounded-full bg-red-100" onClick={() => handleDelete(page._id)}>
                      <Trash2 size={18} className="text-red-500" />
                    </button>
                  </td>
                </tr>
