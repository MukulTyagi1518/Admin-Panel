...
//       try {
//         const res = await fetch(`https://e-commerce-backend-1-0.onrender.com/api/websetpage/websetpage/${id}`);
...
//       const res = await fetch(`https://e-commerce-backend-1-0.onrender.com/api/websetpage/${id}`, {
//         method: "PUT",
//         body: formData,
//       });
  ...
  useEffect(() => {
    async function fetchPage() {
      try {
        ...
        setForm({
          title: data.title || "",
          slug: data.slug || "", // Ensure slug is fetched properly
          content: data.content || "",
          metaTitle: data.metaTitle || "",
          metaDescription: data.metaDescription || "",
          metaKeywords: data.metaKeywords || "",
