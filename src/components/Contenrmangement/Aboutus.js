...
const AboutUsEditor = () => {
  ...
  const fetchAboutUs = async () => {
    try {
      const res = await fetch('https://e-commerce-backend-1-0.onrender.com/api/aboutus/get');
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch('https://e-commerce-backend-1-0.onrender.com/api/aboutus/create', {
        method: 'POST',
