...
const PrivacyEditor = () => {
  ...
  const fetchAboutUs = async () => {
    try {
      const res = await fetch('https://e-commerce-backend-1-0.onrender.com/api/privacypolicy/get');
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch('https://e-commerce-backend-1-0.onrender.com/api/privacypolicy/create', {
        method: 'POST',
