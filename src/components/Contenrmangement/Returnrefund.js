...
const ReturnEditor = () => {
  ...
  const fetchAboutUs = async () => {
    try {
      const res = await fetch('https://e-commerce-backend-1-0.onrender.com/api/return-policy/get');
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await fetch('https://e-commerce-backend-1-0.onrender.com/api/return-policy/create', {
        method: 'POST',
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-gray-800 text-white rounded-lg shadow-lg my-10">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold">Return and Refund </h2>
