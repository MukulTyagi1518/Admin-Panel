...
const StateEdit = () => {
  ...
  useEffect(() => {
    const fetchStateData = async () => {
      try {
        const response = await fetch(`https://e-commerce-backend-1-0.onrender.com/api/shippingState/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await fetch(`https://e-commerce-backend-1-0.onrender.com/api/shippingState/update/${id}`, {
