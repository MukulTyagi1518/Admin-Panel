...
const RefundRequestTable = () => {
    ...
    const fetchRefundRequests = async () => {
        try {
            const res = await fetch("https://e-commerce-backend-1-0.onrender.com/api/refund");
    ...
    const handleApprove = async (id) => {
        try {
            const res = await fetch(`https://e-commerce-backend-1-0.onrender.com/api/refund/approve/${id}`, {
                method: "PUT",
                headers: {
    ...
    const handleReject = async (id) => {
        ...
        try {
            const res = await fetch(`https://e-commerce-backend-1-0.onrender.com/api/refund/reject/${id}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                },
