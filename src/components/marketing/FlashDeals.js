          ...
          <label className="switch">
            <input
              ...
              onChange={(e) => {
                ...
                console.log(`Publish toggled for ${item.title}:`, e.target.checked);
              }}
            />
          ...
          <label className="switch">
            <input
              ...
              onChange={(e) => {
                ...
                console.log(`Feature toggled for ${item.title}:`, e.target.checked);
              }}
            />
            <span className="slider"></span>
          </label>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
        <div className="flex space-x-2 overflow-x-auto pb-2">
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${activeTab === 'all' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
          >
            All Deals
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${activeTab === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
          >
            Active
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${activeTab === 'upcoming' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
          >
            Upcoming
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-md ${activeTab === 'expired' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
          >
            Expired
          </button>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Add New Flash Deal</h3>
                <button
      ...
      {showDeleteModal && (
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-medium text-gray-900">Delete Flash Deal</h3>
                <button
              ...
              <p className="text-sm text-gray-500 mb-6">
                Are you sure you want to delete this flash deal? This action cannot be undone.
              </p>
